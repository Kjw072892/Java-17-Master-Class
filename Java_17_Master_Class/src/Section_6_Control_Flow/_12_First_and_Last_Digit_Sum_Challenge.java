...
public class _12_First_and_Last_Digit_Sum_Challenge {
...
sumFirstAndLastDigit(252); → should return 4, the first digit is 2, and the last is 2 that gives us 2+2, and the sum is 4.

sumFirstAndLastDigit(257); → should return 9, the first digit is 2, and the last is 7 that gives us 2+7,
    and the sum is 9.
