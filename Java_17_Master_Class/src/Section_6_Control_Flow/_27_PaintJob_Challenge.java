...
public class _27_PaintJob_Challenge {
/*
    Paint Job
Bob is a wall painter and he needs your help. You have to write a program that helps Bob calculate how many buckets of
paint he needs to buy before going to work. Bob might also have some extra buckets at home. He also knows the area that he can cover with one bucket of paint.
...
getBucketCount(3.4, 2.1, 1.5, 2); → should return 3 since the wall area is 7.14, a single bucket can cover an area
...
getBucketCount(3.4, 2.1, 1.5); → should return 5 since the wall area is 7.14, and a single bucket can cover an
area of 1.5.

getBucketCount(7.25, 4.3, 2.35); → should return 14 since the wall area is 31.175, and a single bucket can cover
an area of 2.35.
...
If one of the parameters area or areaPerBucket is less or equal to 0, the method needs to return -1 to indicate an
invalid value.
...
getBucketCount(3.26, 0.75); → should return 5 since the wall area is 3.26, and a single bucket can cover an area of
0.75.
 ...
 */
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets){
        ...
        return (int) Math.ceil((width * height) / areaPerBucket) - (extraBuckets);// returns # buckets / extra buckets
    }
     ...
     public static int getBucketCount(double width, double height, double areaPerBucket){
        ...
        return (int) Math.ceil((width * height) / areaPerBucket);// returns # of buckets assuming 0 extra buckets
    }
    ...
    public static int getBucketCount(double area, double areaPerBucket){
        ...
        return (int) Math.ceil(area / areaPerBucket);// returns # of buckets
    }
