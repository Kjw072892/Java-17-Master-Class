...
public class _18_Perfect_Number_Challenge {
    /*
        Perfect Number
    ...
    isPerfectNumber(28); should return true since its proper divisors are 1, 2, 4, 7, 14 and the sum is
    1 + 2 + 4 + 7 + 14 = 28
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isPerfectNumber(10)); // False: 1 + 2 + 5 = 8
